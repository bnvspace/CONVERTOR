...
## 2. Language Rules
*   **Communication**: Strictly Russian language for all interactions with the developer.
*   **Documentation**: All .md files, comments, and commit messages must be in Russian.
*   **Exceptions**: Standard English technical terms/keywords where translation would hurt clarity.
